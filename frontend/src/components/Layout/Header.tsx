...
import { Menu, Bell, AlertTriangle, Wallet, TrendingUp, Sun, Moon } from 'lucide-react';
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold text-gray-900 dark:text-white">Envelope Notifications</h3>
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.length === 0 ? (
                    <div className="p-4 text-center text-gray-500 dark:text-gray-400">
                      <Wallet className="w-8 h-8 mx-auto mb-2 text-gray-400 dark:text-gray-500" />
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
                      ...
                      {criticalNotifications.map((envelope) => (
                        <div key={envelope.id} className="p-4 hover:bg-red-50 dark:hover:bg-red-900/20 bg-red-50/30 dark:bg-red-900/10">
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center space-x-2">
                                <p className="font-medium text-gray-900 dark:text-white">{envelope.category_name}</p>
                      ...
                      {warningNotifications.map((envelope) => (
                        <div key={envelope.id} className="p-4 hover:bg-yellow-50 dark:hover:bg-yellow-900/20 bg-yellow-50/30 dark:bg-yellow-900/10">
                          <div className="flex items-start space-x-3">
